...
def index(request):
    ...
    posts_with_comments = Post.objects.fetch_with_comments_count(posts_ids)
    ...
    most_popular_tags = Tag.objects.popular()[:5].prefetch_related(Prefetch('posts')).annotate(posts_count=Count('posts', distinct=True))
